...
module "intersight_pod1_dcloud" {                                            # <-- Change when copied
...
# -----------------------------------------------------------------------------
  ...
  # This is the domain name. Every policy created will have this prefix in its name
  policy_prefix = "${local.pod_policy_prefix}-dcloud"                            # <-- Change domain name when copied
...
# -----------------------------------------------------------------------------
  ...
  chassis_imc_access_vlan  = 10     #dcloud is 10   richfield aci-kvm is 101
...
# fi_a_sn = "FDO244000GQ"
# fi_b_sn = "FDO2440009A"
fi_model = "UCS-FI-6454"   # Options dcloud "UCS-FI-6454" or Richfield "UCS-FI-64108"
