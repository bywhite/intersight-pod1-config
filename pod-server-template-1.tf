...
module "server_template_1" {                                                  # <<-- Change when copied
...
# -----------------------------------------------------------------------------
  ...
  server_policy_prefix = "${local.pod_policy_prefix}-vmw1"                    # <<-- Change when copied
  ...
  tags = [
    ...
    { "key" : "ServerTemplate", "value" : "${local.pod_policy_prefix}-vmw1" }  # <-- Change when copied
  ]
